...
$product_id = isset($_GET['id']) ? intval($_GET['id']) : 8;
$product = null;
$variants = [];
  ...
  <div class="container-section">
    <div class="container">
      <div class="image-section">
        <img src="assets/assets/image/katalog8.png" alt="Bow Hair Clips">
        <p class="caption">Bow Hair Clips</p>
      </div>
