  ...
  <div class="container-section">
    <div class="container">
      <div class="image-section">
        <img src="assets/assets/image/katalog10.png" alt="Puffy Headband">
        <p class="caption">Puffy Headband</p>
      </div>
      ...
      <div class="details">
        ...
        <div class="colors">
          <div class="color-box" style="background-image: url('assets/assets/image/ungu.png');"></div>
          <div class="color-box" style="background-image: url('assets/assets/image/pink.jpg');"></div>
          <div class="color-box" style="background-image: url('assets/assets/image/biru.png');"></div>
        </div>
